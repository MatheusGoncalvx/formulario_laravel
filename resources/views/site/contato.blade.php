...
<section id="sessao-1" class="py-12 bg-yellow-500">
    <form action="{{ route('site.contato') }}" method="post" class="max-w-sm mx-auto">
            ...
            <button type="submit"
                class="text-white bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Enviar</button>
        </form>
    </section>
</main>
